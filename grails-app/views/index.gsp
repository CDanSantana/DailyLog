        ...
        <div class="col-xl-12">
            ...
            <script type="application/javascript">
                document.addEventListener("DOMContentLoaded", function(event) {
                    ...
                    document.getElementsByClassName('badge-today')[0].role='link';
                });

                function myDateFunction(id) {
                    var date = $("#" + id).data("date");
                    var hasEvent = $("#" + id).data("hasEvent");
                    var baseLink = '<g:createLink action="index" controller="logEntry" id="DATE"/>';
                    window.location.href = baseLink.replace("DATE", date);
                }
